...
class Plotter:
    def __init__(self, stats=[], name='MLP'):
        self.stats = stats
        self.name = name
        self.axes = self.make_mlp_training_plot()

    def make_mlp_training_plot(self):
        """
    ...
    def log_mlp_training(self, epoch):
        """
    ...
    def update_mlp_training_plot(self, epoch):
        """
    ...
    def save_mlp_training_plot(self):
        """
